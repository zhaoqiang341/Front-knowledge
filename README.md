...
- [腾讯移动Web前端知识库](https://github.com/AlloyTeam)
...
- [gitbook国外的在线markdown可编辑成书](https://www.gitbook.com/) 
- [mdeditor 一款国内的在线markdown编辑器](https://www.zybuluo.com/mdeditor) 
- [stackedit国外的在线markdown编辑器，功能强大，同步云盘](https://stackedit.io) 
- [mditor一款轻量级的markdown编辑器](http://bh-lay.github.io/mditor/) 
